...
const ComimgSoon = () => {
    return (
        <>
            <HeadMeta metaTitle="Apilats.cat" />
            <div className="under-construction-banner" style={{backgroundImage: "url(images/others/under-construction-banner.png)"}}>
                <div className="container">
                    <div className="row">
                        <div className="col-xl-6">
                            <div className="under-construction-inner-content">
                                <div className="brand-logo-container">
                                    <h1 style={{color: "#FF7A33"}}>Apilats.cat</h1>
                                </div>
                                {/* End of .brand-logo-container */}
                                <div className="axil-title">
                                    <h1 className="h1 m-0">Aquest projecte està en construcció</h1>
                                </div>
                                { false &&
                                    ...
                                    <div className="subscription-form-wrapper">
                                        <form action="#" className="subscription-form row no-gutters">
                                            ...
                                            <div className="m-b-xs-0 col-auto">
                                                <button className="btn btn-primary">SUBSCRIUTE</button>
                                            </div>
                                        </form>
